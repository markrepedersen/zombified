...
int loadObject(const char* filename)
{
    ...
    {
        if (coord[i]->c_str()[0]=='#')  // must be a comment
            continue;
    ...
    int num=glGenLists(1); // ID for the display list
...
void init()
{
    ...
    testObject=loadObject("/Users/markpedersen/Desktop/zombified/Zombified/Zombified/assets/436d_test.obj");
...
void display()
{
    ...
    glCallList(testObject);
}

int main() {
    SDL_Init(SDL_INIT_EVERYTHING);
    SDL_Window *screen = SDL_CreateWindow("Zombified",
