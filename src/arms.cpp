...
bool Arms::init()
{
    ...
    float wr = arms_texture.width * 0.5f;
    float hr = arms_texture.height * 0.5f;
...
void Arms::draw(const mat3& projection)
{
    ...
    glBindTexture(GL_TEXTURE_2D, arms_texture.id);
