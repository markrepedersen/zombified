...
Texture Lifep2::onequart_texture;
Texture Lifep2::twoquart_texture;
Texture Lifep2::threequart_texture;
Texture Lifep2::full_texture;

bool Lifep2::init(std::string life)
{
    // Load shared texture
    ...
    if(type == "one") {
        ...
        m_position = { 1150.f* ViewHelper::getRatio(), 540.f* ViewHelper::getRatio() };
...
void Lifep2::draw(const mat3& projection)
{
    //scale();
